...
- [ ] **⏳ Aplicar `migrations/027_caja_sesion_unica.sql` en BD staging y prod** (índice único parcial: una sesión de caja abierta por tenant — cierra la carrera de doble apertura). El usuario corre el SQL (regla #4); antes verificar duplicados abiertos con el SELECT comentado en el archivo.
